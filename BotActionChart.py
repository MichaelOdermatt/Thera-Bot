...
actionChart = {
  "depression": {"confirmation": "Depression (mood)", "decline": "Ok, but I'll be here if you change your mind."},
  "stress": {"confirmation": "Stress (biology)", "decline": "Ok, but you should really think about taking things easier." },
  "loneliness": {"confirmation": "Loneliness", "decline": "Ok, if you want to talk I'll always be here." },
}